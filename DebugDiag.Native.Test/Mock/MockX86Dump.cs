...
namespace DebugDiag.Native.Test.Mock
{
    internal class MockX86Dump : IDumpContext
    {
        ...
        static MockX86Dump()
        {
            ...
            InputOutputMap["dt 0x29cc00 DebugDiag_Native_Test_App!VirtualType"] = Fixtures.X86.StaticDtDrillSubType;
            InputOutputMap["dt DebugDiag_Native_Test_App!PODType 0x29cc14"] = Fixtures.X86.StaticDtDrillPod;
            InputOutputMap["dt 0x29cc14 DebugDiag_Native_Test_App!PODType"] = Fixtures.X86.StaticDtDrillPod;
            //InputOutputMap[""] =;
        }
