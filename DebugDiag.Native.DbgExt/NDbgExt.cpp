...
EXT_COMMAND(map,
    ...
    "{;e;address;The address of the container.}{skip;ed,o,d=0;skip;Skips the specified number of elements}{max;ed,o,d=0;;Maximum number of entries to analyze}{v;b,o;verbose;Enable verbosity}{;x,o;command;The command to run on each object in the container.}")
{
